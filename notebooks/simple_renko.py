...
def _():
    ...
    from utils import run_backtest_short, print_backtest_report, analyze_yearly_intensity
...
def _(df_signals, print_backtest_report, run_backtest_short):
    ...
    df_result_dynamic = run_backtest_short(df_signals, signal_col='renko_signal', return_days=return_days, loose_periods=LOOSE_PERIODS, top_n=200, stop_loss_pct=0.00)

//! AMV close-to-close cohort diagnostic ECS resources.
...
pub struct CohortDiagnosticConfig {
    pub initial_capital: f64,
    pub max_positions: usize,
    pub max_daily_buys: usize,
    pub position_size_pct: f64,
...
impl Default for CohortDiagnosticConfig {
    fn default() -> Self {
        Self {
            initial_capital: 500_000.0,
            max_positions: 21,
            max_daily_buys: 3,
            position_size_pct: 1.0 / 21.0,
            ...
            max_open_gap_pct: Some(0.098),
            cost_model: CostModel::default(),
        }
    }
}

impl From<ConfigFile> for CohortDiagnosticConfig {

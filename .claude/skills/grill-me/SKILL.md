...
Before asking, read the relevant code so questions are grounded in the current implementation, not assumptions. If a question can be answered by exploring the codebase, explore first.